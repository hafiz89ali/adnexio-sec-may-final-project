// This code is still not complete. Some requirements are still not meet.
// - Lesson plan can be deleted only if not submit to reviewer.
// - If lesson plan have been reviewed, it cannot be deleted forever
